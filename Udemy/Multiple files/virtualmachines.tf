...
# resource "local_file" "tf-ansible-inventory" {
#   content = templatefile("inventory.tmpl",
#     {
#       ansible_group_ip = azurerm_windows_virtual_machine.tf-winsrv2019.*.ip_address
#     }
#   )
#   filename = "inventory"
# }
...
#   value = {
#     for vm in azurerm_windows_virtual_machine.tf-winsrv2019:
