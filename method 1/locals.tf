locals {
  ...
  #* Subnet Variables
  name_of_subnet_dmgmt = ["GatewaySubnet", "sg-sea-dmgmt-bastionsnet-sn", "sg-sea-Jumpboxsnet-sn"]
  subnet_address_space_dmgmt = ["10.80.0.0/26", "10.80.1.0/26", "10.80.11.0/24"]
